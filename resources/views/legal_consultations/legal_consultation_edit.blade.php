...
<html lang="ar">
  <head>
    ...
    <!-- =============== APP TITLE ===============-->
    <title>اضافة استشارة قانونية</title>
    <!-- =============== APP STYLES ===============-->
    <link rel="stylesheet" href="../css/style__rtl.css">
    <!-- =============== APP SCRIPT ===============-->
        ...
        <div class="wrapper">
          ...
          <div class="full-body">
            ...
            <nav class="navbar navbar-fixed-top bgcolor--gray_m bshadow--0 bradius--noborder " id="sidebar-wrapper" role="navigation">
              <ul class="sidebar-navigation">
                <li class="brand bgcolor--gray_m bshadow--0"><a href="index.html"> <img src="../img/logo/logo__dark.png" alt="جسر الأمان"></a></li>
              </ul>
              <div class="coverglobal text-center bshadow--2" style="background:#f7f7f7  ;">
                ...
                <div class="text-center"><a href="user_profile.html"><img class="coverglobal__avatar bradius--circle" src="../img/avaters/male.jpg">
                ...
                <ul class="side-menu">
                  <li class="side__list"> <a class="side__item side__item--sub color--gray_d bgcolor--gary_m ">البيانات الأساسية</a>
                    <ul class="side__submenu">
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="cases_types.html">انواع القضايا</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="governorates_cities.html">المدن و المحافظات</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="courts_list.html">اسماء المحاكم</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="contracts_formulas_types.html">انواع الصيغ و العقود</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="consultations_classification.html">تصنيف الاستشارات</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="about.html">عن جسر الأمان</a></li>
                    </ul>
                  </li>
                  <li class="side__list"> <a class="side__item color--gray_d bgcolor--gray_m" href="formulast.html">العقود و الصيغ</a>
                  </li>
                  <li class="side__list"> <a class="side__item color--gray_d bgcolor--gray_m" href="users_list.html">المستخدمين</a>
                  </li>
                  <li class="side__list"> <a class="side__item color--gray_d bgcolor--gray_m" href="news_list.html">الاخبار</a>
                  </li>
                  <li class="side__list"> <a class="side__item side__item--sub color--gray_d bgcolor--gary_m ">العملاء</a>
                    <ul class="side__submenu">
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="clients_content.html">محتوى</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="notifications_list.html">التنبيهات</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="clients_complains.html">الشكاوى و الاستفسارات</a></li>
                    </ul>
                  </li>
                  <li class="side__list"> <a class="side__item color--gray_d bgcolor--gray_m" href="lawyers-list.html">السادة المحامين</a>
                  </li>
                  <li class="openedmenu side__list opened-sublist"><a class="side__item color--white bgcolor--sec" href="legal_consultations.html">الاستشارات القانونية</a>
                  </li>
                  <li class="side__list"> <a class="side__item side__item--sub color--gray_d bgcolor--gary_m ">القضايا و الخدمات</a>
                    <ul class="side__submenu">
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="cases_list.html">القضايا</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="services_list.html">الخدمات</a></li>
                    </ul>
                  </li>
                  <li class="side__list"> <a class="side__item side__item--sub color--gray_d bgcolor--gary_m ">المهام</a>
                    <ul class="side__submenu">
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="tasks_list.html">المهام العادية</a></li>
                      <li class="side__sublist"><a class="side__subitem color--gray_d bgcolor--gray_l" href="emergency-list.html">الحالات الطارئة</a></li>
                    </ul>
                  </li>
                  <li class="side__list"> <a class="side__item color--gray_d bgcolor--gray_m" href="reports_statistics.html">تقارير و احصائيات</a>
                  </li>
                  <li class="side__list"> <a class="side__item color--gray_d bgcolor--gray_m" href="records.html">دفتر المحضرين</a>
                  </li>
                </ul>
              </div>
            </nav>
                  ...
                  <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                    <div class="col-lg-6">
                      <div class="master_field">
                        ...
                        <select class="master_input select2" id="consultation_cat" multiple="multiple" data-placeholder="اختر التصنيف الرئيسي للاستشارات القانونية" style="width:100%;" ,>
                    ...
                    <div class="col-xs-12">
                      <div class="master_field">
                        ...
                        <input class="master_input" type="text" placeholder="نص السؤال .." id="consultation_question"><span class="master_message color--fadegreen">message</span>
                      </div>
                    </div>
                    <div class="col-xs-12">
                      <div class="master_field">
                        <label class="master_label mandatory" for="consultation_answer">نص الاجابة</label>
                        <textarea class="master_input" name="textarea" id="consultation_answer" placeholder="نص الاجابة "></textarea><span class="master_message color--fadegreen">message</span>
                      </div>
                    </div>
          ...
          <footer>
            ...
            <div class="footer--1 text-center bgcolor--white color--main bradius--noborder bshadow--3">
              <p>
                 بنتافاليو<img src="../img/powered.png" alt="pentavalue" height="20">-<a href="http://pentavalue.com/en" target="_blank"></a>جميع الحقوق محفوظة  ©<span class="cp bgcolor--sec color--white bradius--small bshadow--0">جسر الأمان</span>2018</p>
            </div>
          </footer>
        </div>
      </div>
