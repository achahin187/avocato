                ...
                <tr data-indcom="{{ $ind_com->id }}">
                  ...
                  <td>
                    <span class="cellcontent">
                      ...
                      <a href= "#lawyer_notification_{{$ind_com->id}}" ,  class= "noti action-btn bgcolor--fadeorange color--white "><i class = "fa  fa-bell"></i></a>
                      {{--  Delete  --}}
                  ...
                  <td hidden>       
                    <div class="col-md-2 col-sm-3 colxs-12"><a class="master-btn undefined undefined undefined undefined undefined" href="#lawyer_notification_{{$ind_com->id}}"><span></span></a>
                    <div class="remodal-bg"></div>
                    <div class="remodal" data-remodal-id="lawyer_notification_{{$ind_com->id}}" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
                      <button class="remodal-close" data-remodal-action="close" aria-label="Close"></button>
                      <div>
                        <form role="form" action="{{route('notification_lawyer',$ind_com->id)}}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
