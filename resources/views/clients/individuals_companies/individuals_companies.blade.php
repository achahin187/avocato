                ...
                <div class="col-lg-12">
                  <div class="cover-inside-container margin--small-top-bottom bradius--small bshadow--1" style="background:  url( '{{asset('img/covers/dummy2.jpg')}}' ) no-repeat center center; background-size:cover;">
                    <div class="row">
                      ...
                      <div class="cover--actions"><a class="color--gray_d bordercolor--gray_d bradius--small border-btn master-btn" type="button" href="{{route('individuals_companies_create')}}">اضافة عميل أفراد-شركات جديد </a>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <table class="table-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><span class="cellcontent">محمد محمود</span></td>
                            <td><span class="cellcontent">24 شارع 90 - التجمع </span></td>
                            ...
                            <td><span class="cellcontent"><a href= "{{route('individuals_companies_show')}}" ,  class= "action-btn bgcolor--main color--white "><i class = "fa  fa-eye"></i></a><a href= "{{route('individuals_companies_edit')}}" ,  class= "action-btn bgcolor--fadegreen color--white "><i class = "fa  fa-pencil"></i></a><a href="#"  class= "btn-warning-cancel action-btn bgcolor--fadebrown color--white "><i class = "fa  fa-trash-o"></i></a></span></td>
                          </tr>
                          <tr>
                            <td><span class="cellcontent"><input type="checkbox" class="checkboxes" /></span></td>
                            <td><span class="cellcontent">2012</span></td>
