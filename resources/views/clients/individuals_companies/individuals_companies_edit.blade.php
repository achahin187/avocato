                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      <div class="col-xs-6">
                        <div class="master_field">
                          ...
                          <input class="master_input" type="text" placeholder="كود الشركة .." id="comp_code"><span class="master_message color--fadegreen">message</span>
                        </div>
                      </div>
                      <div class="col-xs-6">
                        <div class="master_field">
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-xs-6">
                        <div class="master_field">
                          ...
                          <input class="master_input" type="number" placeholder="قيمة التعاقد" id="license_amount"><span class="master_message color--fadegreen">message</span>
                        </div>
                      </div>
                      <div class="col-xs-6">
                        <div class="master_field">
                      ...
                      <div class="col-xs-4">
                        <div class="master_field">
                          ...
                          <input class="datepicker-popup master_input" type="text" placeholder="placeholder" id="license_date"><span class="master_message color--fadegreen">message</span>
                        </div>
                      </div>
                      <div class="col-xs-4">
                        <div class="master_field">
