    ...
    <div class="row">
        ...
        <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
            ...
            <div class="master_field">
                ...
                <input name="phone" value="{{ $user->phone }}" class="master_input" type="number" placeholder="0212345678" id="client_tel">          
                {{--  Error  --}}         
                @if ($errors->has('phone'))          
      ...
      @if($user->bouquets->count() > 0)
       @foreach($user->bouquets as $bouquet)
          ...
          <div class="col-md-3 col-sm-4 col-xs-12" id="company_count" @if($bouquet->bouquet_type == 0) hidden @endif>
            <div class="master_field">
