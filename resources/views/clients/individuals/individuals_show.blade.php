                    ...
                    <div class="container">
                      <div class="row">
                        <div class="col-xs-12">
                          ...
                          <div class="coverglobal__actions"><a class="color--gray_d bordercolor-gray_d bradius--small border-btn master-btn" type="button" href="{{route('individuals_edit')}}">تعديل بيانات العميل</a><a class="color--gray_d bordercolor-gray_d bradius--small border-btn master-btn" type="button" href="{{route('individuals_companies_create')}}">التحويل لعميل أفراد-شركات</a><a class="color--gray_d bordercolor-gray_d bradius--small border-btn master-btn" type="button" href="">كارت العميل</a><a class="color--gray_d bordercolor-gray_d bradius--small border-btn master-btn" type="button" href="">استبعاد العميل</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="row"><b class="col-xs-4">كود العميل </b>
                        <div class="col-xs-8">65339</div>
                      </div>
                      <div class="row"><b class="col-xs-4">الرقم القومى </b>
                        <div class="col-xs-8">373229004322</div>
                      </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                      <div class="row"><b class="col-xs-4">عنوان العميل</b>
                        <div class="col-xs-8">شارع ال 90 التجمع الخامس</div>
                      </div>
                      <div class="row"><b class="col-xs-4">البريد الالكترونى </b>
                        <div class="col-xs-8"> <span>company@info.com</span></div>
                      </div>
                      <div class="row"><b class="col-xs-4">تاريخ الميلاد </b>
                        <div class="col-xs-8">19-10-2015</div>
                      </div>
                    </div>
                        ...
                        <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                          <div class="row">
                            ...
                            <div class="col-xs-6"><b class="col-xs-3">نوع الباقة </b>
                              <div class="col-xs-9"> <span class="bgcolor--fadepurple color--white bradius--small importance padding--small">بلاتيني</span></div>
                            </div>
                            ...
                            <table class="table-1">
                              ...
                              <tbody>
                                <tr>
                                  ...
                                  <td><span class="cellcontent"><a href= #payment_status ,  class= "action-btn bgcolor--fadegreen color--white "><i class = "fa  fa-pencil"></i></a></span></td>
                                </tr>
                                <tr>
                                  <td><span class="cellcontent">القسط الاول</span></td>
                                  <td><span class="cellcontent"> 1000</span></td>
