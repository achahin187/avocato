                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input class="master_input" type="text" placeholder="اسم المكتب .." id="office_name" name="office_name" value="{{$office->name}}">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input class="master_input" type="text" placeholder="عنوان المكتب .." id="office_address" name="office_address" value="{{$office->address}}">
                          <span class="master_message color--fadegreen">
                     ...
                     <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="office_mobile" value="{{$office->mobile}}"  class="master_input" type="text" placeholder="+201200000000 or +966100000000" id="office_tel">
                          <span class="master_message color--fadegreen" >
                       ...
                       <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="office_email" value="{{$office->email}}" class="master_input" type="email" placeholder="البريد الالكترونى" id="office_email">
                          <span class="master_message color--fadegreen" >
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="master_field">
                          ...
                          <textarea value="{{ old('note') }}" class="master_input" name="note" id="office_info" placeholder="نبذة">{{$office->note}}</textarea>
                          <span class="master_message color--fadegreen">
                              @if ($errors->has('note'))
                                  {{ $errors->first('note')}}
                              @endif
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input class="master_input" type="number" placeholder="رقم بطاقة الممثل القانوني" id="rep_id" name="rep_nid" value="{{$representative->user_detail->national_id}}">
                          <span class="master_message color--fadegreen">
                     ...
                     <div class="col-md-4 col-sm-6 col-xs-12">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input class="master_input" type="text" placeholder="درجة التقاضي.." id="rep_litigation_level" name="rep_litigation_level" value="{{$representative->user_detail->litigation_level}}">
                          <span class="master_message color--fadegreen">
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="master_field">
                            ...
                            <input class="master_input" type="text" placeholder="اسم الفرع..." id="branch_name"  name="branches[branch_name][]" value="{{$branch->name}}">
                            <span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="master_field">
                            ...
                            <input class="master_input" type="text" placeholder="عنوان الفرع..." id="branch_address" name="branches[branch_address][]"  value="{{$branch->address}}">
                            <span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="master_field">
                            ...
                            <input class="master_input" type="number" placeholder="رقم الهاتف" id="branch_tel" name="branches[branch_phone][]" value="{{$branch->phone}}">
                            <span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="master_field">
                            ...
                            <input class="master_input" type="email" placeholder="البريد الالكترونى" id="branch_email" name="branches[branch_email][]" value="{{$branch->email}}">
                            <span class="master_message color--fadegreen">
