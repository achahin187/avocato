          ...
          <div class="tabs--wrapper">
              ...
              <ul class="tab__content">
                ...
                <div class="col-md-2 col-sm-3 colxs-12 pull-right"><a class="master-btn color--white bgcolor--main bradius--small bshadow--0 btn-block" href="#popupModal_1"><i class="fa fa-plus"></i><span>إضافة</span></a>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-xs-12">
                                    <div class="master_field">
                                      ...
                                      <input class="master_input" type="text" placeholder="تصنيف الصيغة / العقد" id="type"><span class="master_message color--fadegreen">message</span>
                                    </div>
                                  </div>
                          ...
                          <div class="full-table">
                            ...
                            <div class="remodal" data-remodal-id="lang1" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
                              ...
                              <div>
                                <div class="row">
                                  <h4>ادخال التصنيف "اسم التصنيف" باللغات</h4><br>
                                  <div class="col-sm-5">
                                    <div class="master_field">
                                  ...
                                  <div class="col-sm-7">
                                    <div class="master_field">
                                      ...
                                      <input class="master_input" type="text" placeholder="اسم التصنيف" id="contract_type_new1"><span class="master_message color--fadegreen">message</span>
                                    </div>
                                  </div>
                                  <div class="clearfix"></div>
                                </div>
                ...
                <li class="tab__content_item">
                  <div class="col-md-2 col-sm-3 colxs-12 pull-right"><a class="master-btn color--white bgcolor--main bradius--small bshadow--0 btn-block" href="#popupModal_2"><i class="fa fa-plus"></i><span>إضافة</span></a>
                    <div class="remodal-bg"></div>
                    <div class="remodal" data-remodal-id="popupModal_2" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
                      <button class="remodal-close" data-remodal-action="close" aria-label="Close"></button>
                      <div>
                        <!-- <div class="row">
                          <div class="col-xs-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-12">
                            <div class="master_field">
                              <label class="master_label mandatory" for="main_type">التصنيف الرئيسي للصيغة / العقد</label>
                              <select class="master_input select2" id="main_type" style="width:100%">
                          ...
                          <div class="col-xs-12">
                            <div class="master_field">
                              <label class="master_label mandatory" for="type_main">التصنيف الفرعي للصيغة / العقد</label>
                              <input class="master_input" type="text" placeholder="نوع الصيغة / العقد" id="type_main"><span class="master_message color--fadegreen">message</span>
                            </div>
                          </div>
                          <div class="col-md-3 col-sm-6 col-xs-12">
