              ...
              <table class="table-1" id="dataTableTriggerId_001">
                ...
                <tbody>
                  ...
                  <tr data-session-id="{{$session->id}}">
                    ...
                    <td><span class="cellcontent">{{($session->case->clients) ? $session->case->clients['full_name'] / Helper::localizations('case_client_roles','name',$session->case->clients['pivot']['case_client_role_id']) : 'لا يوجد'}}</span></td>
