    ...
    $(document).ready(function(){
        ...
        $("select[name='mains']").change(function () {
          ...
          if (main_id !== '' && main_id !== null) {
            $("select[name='subs']").prop('disabled',false).find('option[value]').remove();
          ...
          $.ajax({
            ...
            $("select[name='subs']").append($("<option></option>").attr("value", key).text(value));
            });
          ...
          <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
            ...
            <div class="col-sm-5 col-xs-12">
              <div class="master_field">
                ...
                <input name="contract_name" value="{{ old('contract_name') }}" class="master_input" type="text" placeholder="اسم العقد / الصيغة .." id="contract_name">
                <span class="master_message color--fadegreen">
