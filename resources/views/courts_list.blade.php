                            ...
                            <div class="col-xs-12">
                              ...
                              <div class="col-xs-12">
                                <div class="master_field">
                                  ...
                                  <input class="master_input" type="text" placeholder="اسم المحكمة" id="ID_No"><span class="master_message color--fadegreen">message</span>
                                </div>
                              </div>
                              <div class="col-xs-6">
                                <div class="master_field">
                                  <label class="master_label mandatory" for="gover2">اسم المحافطة </label>
                                  <select class="master_input select2" id="gover2" multiple="multiple" data-placeholder="اختر المحافظة" style="width:100%;" ,>
                                    <option>القاهرة</option>
                                    <option>الجيزة</option>
                              ...
                              <div class="col-xs-6">
                                <div class="master_field">
                                  ...
                                  <select class="master_input select2" id="city2" multiple="multiple" data-placeholder="اختر المدينة" style="width:100%;" ,>
