...
@section('content')
    ...
    <div class="col-md-9">
        <div  class="row">
            <button type="image" onclick="checkout()" alt="pay-using-fawry" id="fawry-payment-btn"  class= "noti action-btn bgcolor--fadeorange color--white ">Pay by fawry</button>
          ...
          @else
            ...
            @foreach ($payments as $payment)
              <tr data-payment="{{ $payment->id}}">
                <td><span class="cellcontent"><input type="checkbox" class="checkboxes" data-id="{{ $payment->id }}" /></span></td>
                ...
                <td><span class="cellcontent"><i class = "fa {{ $payment->statusCode ? ' color--fadegreen fa-check' : 'fa-times  color--fadebrown'}}"></i></span></td>
                <td>
                  <span class="cellcontent">
                    ...
                    {{--  Delete  --}}
                    <a href="#" class="btn-warning-cancel action-btn bgcolor--fadebrown color--white deleteRecord" data-id="{{ $payment->id }}">
                      <i class="fa fa-trash-o"></i>
                    </a>
