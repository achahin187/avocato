...
<body>
        ...
        <div class="layout_sidebar">
            <div class="wrapper">
                ...
                <header class="topnavbar-wrapper">
                    <nav
                        class="top-navbar navbar-expand-lg bgcolor--gray_m color--gray_d bradius--noborder bshadow--1 ">
                        <div class="container-fluid"><span></span>
                            <ul class="actionsbar moile-view hidden-lg hidden-md hidden-sm">
                                <li class="dropdowny"><a class="dropdowny-toggle color--gray_d" href="#"><i
                                            class="fa fa-bell"></i></a>
                                    <ul class="dropdowny-menu" role="menu">
                                        <li><a href="#">
                                                <div class="icon-container"><i class="fa fa-volume-up"></i></div>
                                                <p>lorem ipsum dollar lorem ipsum dollarss</p><span
                                                    class="notification_date"><i class="fa fa-clock-o"></i>5/11/2015
                                                    11:00:00AM</span>
                                            </a></li>
                                        <li><a href="#">
                                                <div class="icon-container"><i class="fa fa-volume-up"></i></div>
                                                <p>lorem ipsum dollar lorem ipsum</p><span class="notification_date"><i
                                                        class="fa fa-clock-o"></i>5/11/2015
                                                    11:00:00AM</span>
                                            </a></li>
                                        <li><a href="#">
                                                <div class="icon-container"><i class="fa fa-volume-up"></i></div>
                            ...
                            <div class="collapse navbar-collapse nav pull-right bgcolor--gray_m"
                                id="navbarSupportedContent">
                                <ul class="navbar-nav">
                                    <li class="nav-item"><a class="nav-link   color--gray_d" href=" .html "
                                            title=" "> </a></li>
                                </ul>

                                <ul class="actionsbar desktop-view hidden-xs">
                                    <li class="dropdowny"><a class="dropdowny-toggle color--gray_d" href="#"><i
                                                class="fa fa-bell"></i><span class="badge badge-default">
                                                {{ $counter }}</span></a>
                                        <ul class="dropdowny-menu" role="menu">
                                            @foreach ($notes as $note)
                                                <li @if ($note->is_read == 1) class="read" @endif
                                                    data-notification-id={{ $note->id }}>

                                                    <a class="notification"
                                                        @if ($note->url != null || $note->url != '') href="{{ $note->url }}" @endif>
                                                        <div class="icon-container"><i class="fa fa-volume-up"></i>
                                                        </div>
                                                        <p>{{ $note->msg }}
                                                        ...
                                                        <span class="notification_date"><i
                                                                class="fa fa-clock-o"></i>{{ $note->created_at }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                    ...
                                    <li><a class="color--gray_d" href="{{ route('logout') }}"
                ...
                <div class="full-body">
                    ...
                    <!-- ==============================================================-->
                    <!-- Sidebar-->
                    <nav class="navbar navbar-fixed-top bgcolor--gray_m bshadow--0 bradius--noborder "
                        id="sidebar-wrapper" role="navigation">
                        <ul class="sidebar-navigation">
                            <li class="brand bgcolor--gray_m bshadow--0"><a href="{{ route('home') }}"> <img
                                        src="{{ asset('img/logo/logo__light.png') }}" alt="جسر الأمان"></a></li>
                        </ul>
                        <div class="coverglobal text-center bshadow--2" style="background:#f7f7f7  ;">
                            <button class="hamburger is-closed" type="button" data-toggle="offcanvas"><span
                                    class="hamb-top bgcolor--main_d"></span><span
                                    class="hamb-middle bgcolor--main_d"></span><span
                                    class="hamb-bottom bgcolor--main_d"></span></button>
                            <div class="text-center">
                                @if (\Auth::check())
                                    @if (Helper::is_admin_superadmin(\Auth::user()->id))
                                        <a href="#">
                                            <img class="coverglobal__avatar bradius--circle"
                                                @if (\Auth::check()) src="{{ asset('' . \Auth::user()->image) }}" @endif>
                                            <h3 class="coverglobal__title color--gray_d">{{ \Auth::user()->name }}
                                            </h3>
                                ...
                                @if (\Auth::check())
                                    @if (auth()->user()->getRole() ==
                                        ...
                                        <li class="side__list"> <a
                                                class="side__item side__item--sub color--gray_d bgcolor--gary_m ">البيانات
                                                الأساسية</a>
                                            <ul class="side__submenu" id="sub_menu">
                                                ...
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                                                        href="{{ route('consultations_classification') }}">تصنيف
                                                        الاستشارات</a></li>
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                                                        href="{{ route('degrees') }}">الدرجات العلمية</a></li>
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                                                        href="{{ route('about') }}">عن جسر الأمان</a></li>
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                                                        href="{{ route('contact_us') }}"> اللينكات </a></li>
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                                                        href="{{ route('contactus_index') }}">اتصل بنا</a></li>
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                                                        href="{{ route('terms_conditions') }}">الشروط و الأحكام</a>
                                                </li>
                                                <li class="side__sublist"><a
                                                        class="side__subitem color--gray_d bgcolor--gray_l"
                ...
                <footer>
                    ...
                    <div class="footer--1 text-center bgcolor--white color--main bradius--noborder bshadow--3">
                        <p>
                            بنتافاليو<img src="{{ asset('img/powered.png') }}" alt="pentavalue" height="20">-<a
                                href="http://pentavalue.com/en" target="_blank"></a>جميع الحقوق محفوظة ©<span
                                class="cp bgcolor--sec color--white bradius--small bshadow--0">جسر الأمان</span>2018
                        </p>
                    </div>
                </footer>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            sub_target.parent().parent().parent().removeClass("bgcolor--gray_m").addClass('bgcolor--sec').addClass(
                'openedmenu').addClass('opened-sublist');
