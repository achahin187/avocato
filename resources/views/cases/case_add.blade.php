                           ...
                           <select class="master_input select2 required"  id="client_code_0" name="client_code[0]" style="width:100%;" onchange="set_client_data(this.value,0,{{$data['clients']}})" required>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="master_field">
                                    ...
                                    <input class="master_input" type="text" placeholder="رقم الهاتف" id="client_number_0"
                                        name="client_number[0]" readonly><span
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="master_field">
                                    ...
                                    <select class="master_input select2" id="client_character_0" name="client_character[0]"
                                        style="width:100%;" class="required">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="master_field">
                                    ...
                                    <input class="master_input required" type="text" placeholder="رقم التوكيل"
                                        id="authorization_num_0" name="authorization_num[0]" required><span
                            ...
                            <div class="col-md-9 col-sm-6 col-xs-12">
                                <div class="master_field">
                                    ...
                                    <input class="master_input" type="text" placeholder="عنوانه" id="client_address_0"
                                        name="client_address[0]" readonly><span class="master_message color--fadegreen">بعض
                                        النص </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="text" placeholder="اسم الخصم"
                                    id="enemy_name" name="enemy_name" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <select class="master_input select2 required" id="enemy_type" name="enemy_type"
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="text" placeholder="محاميه"
                                    id="enemy_lawyer" name="enemy_lawyer" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="text" placeholder="عنوانه"
                                    id="enemy_address" name="enemy_address" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                                <div class="master_field">
                                    ...
                                    <input class="master_input required" type="text" placeholder="رقم المحضر"
                                        id="investigation_no" name="investigation_no" required><span
                                        class="master_message color--fadegreen">
                            ...
                            <div class="col-xs-4">
                                <div class="master_field">
                                    ...
                                    <select class="master_input select2 required" id="investigation_type"
                                        name="investigation_type" style="width:100%;" required>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="master_field">
                                    ...
                                    <div class="bootstrap-timepicker">
                                        <input class="datepicker master_input required" type="text"
                                            placeholder="تاريخ المحضر" id="investigation_date" name="investigation_date"
                                            required>
                                ...
                                <div class="master_field">
                                    ...
                                    <div class="file-upload">
                                        <div class="file-select">
                                            ...
                                            <input class="chooseFile" type="file" name="docs_upload[]"
                                                id="docs_upload" multiple="multiple">
                                        </div>
                    ...
                    <div
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="number" placeholder="رقم الملف بالمكتب"
                                    id="folder_num" name="folder_num" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="number" placeholder="رقم الدعوى"
                                    id="claim_num" name="claim_num" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="number" placeholder="رسوم الدعوى"
                                    id="case_fees" name="case_fees" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <select class="master_input select2 required" id="case_type" name="case_type"
                                    style="width:100%;" required>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class=" master_input required case_year" type="text" placeholder="السنة"
                                    id="case_year" name="case_year" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <div class="bootstrap-timepicker">
                                    <input class="datepicker master_input required" type="text"
                                        placeholder="تاريخ قيد الدعوى " id="case_date" name="case_date" required>
                                </div><span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="date_range_picker master_input required" type="text"
                                    placeholder="ex:John Doe" id="case_dateRang" name="case_dateRang" required><span
                                    class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="master_field">
                                ...
                                <input class="master_input" type="number" placeholder="مصروفات القضية" id="case_fees"
                                    name="case_fees"><span class="master_message color--fadegreen">
                                    @if ($errors->has('case_fees'))
                                        {{ $errors->first('case_fees') }}
                                    @endif
                                </span>
                        ...
                        <div class="col-md-12">
                            <div class="master_field">
                                ...
                                <input class="master_input required" type="text" placeholder="الموضوع" id="subject"
                                    name="subject" required><span class="master_message color--fadegreen">
                ...
                <fieldset>
                    <div class="full-table">
                        <div class="remodal-bg">
                            <div class="remodal" id="confirm" data-remodal-id="filterModal_sponsors" role="dialog"
                                ...
                                <div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <input class="master_input" type="text" placeholder="كود المحامى"
                                                id="lawyer_code" name="lawyer_code"><span
                                                class="master_message color--fadegreen">message</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <input class="master_input" type="text" placeholder="اسم المحامى"
                                                id="lawyer_name" name="lawyer_name"><span
                                                class="master_message color--fadegreen">message</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <input class="master_input" type="number" placeholder="الرقم القومي"
                                                id="lawyer_national_id" name="lawyer_national_id"><span
                                                class="master_message color--fadegreen">message</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <select name="nationalities" class="master_input select2" id="nationality"
                                                data-placeholder="نوع العمل " style="width:100%;" ,>
                                                <option value="0" selected="selected">الكل</option>
                                                @foreach ($data['nationalities'] as $nationality)
                                                    <option value="{{ $nationality->item_id }}">{{ $nationality->value }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <select name="work_sector[]" class="master_input select2" id="lawyer_type"
                                                multiple="multiple" data-placeholder="التخصص" style="width:100%">
                                                <option value="0">choose Speification ..</option>
                                                @foreach ($data['work_sectors'] as $work_sector)
                                                    <option value="{{ $work_sector->id }}">{{ $work_sector->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <select name="syndicate_level_id" class="master_input"
                                                id="syndicate_level_id">
                                    ...
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <input class="master_input" type="number" placeholder="الهاتف"
                                                id="lawyer_tel" name="lawyer_tel"><span
                                                class="master_message color--fadegreen">message</span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="master_field">
                                            ...
                                            <div class="bootstrap-timepicker">
                                                <input class="datepicker master_input" type="text"
                                                    placeholder="تاريخ الالتحاق" id="start_date" name="start_date">
                                            </div><span class="master_message color--fadegreen">message content</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="filter__btns"><a class="master-btn bgcolor--main color--white bradius--small"
                            ...
                            <thead>
                                <tr class="bgcolor--gray_mm color--gray_d">
                                    <th><span class="cellcontent">&lt;input type=&quot;checkbox&quot;
                                            name=&quot;select-all&quot; id=&quot;select-all&quot; /&gt;</span></th>
                            ...
                            <tbody>
                                @foreach ($data['lawyers'] as $lawyer)
                                    <tr data-lawyer-id="{{ $lawyer->id }}">
                                        ...
                                        <td><span class="cellcontent"><input class="input-in-table" type="checkbox"
                                                    id="{{ $lawyer->id }}" name="lawyer_id[{{ $lawyer->id }}]"
                                                    class="checkboxes" /></span></td>

                                        <td><span class="cellcontent">{{ $lawyer->code }}</span></td>
                                        <td><span class="cellcontent">{{ $lawyer->name }}</span></td>
                                        <td><span class="cellcontent">{{ $lawyer->user_detail->national_id or '' }}</span>
                                        </td>
                                        ...
                                        <td><span
                                                class="cellcontent">{{ $lawyer->user_detail->syndicate_levela->name or '' }}</span>
                                        </td>
                                        <td><span class="cellcontent">{{ $lawyer->address }}</span></td>
                                        <td><span class="cellcontent">{{ $lawyer->mobile }}</span></td>
                                        <td><span class="cellcontent">{{ $lawyer->user_detail->join_date or '' }}</span>
                                        </td>
                                        @if ($lawyer->is_active)
