              ...
              <div class="row">
                ...
                <div class="col-lg-3">
                  <div class="stat-box stat-box-3 margin--small-top-bottom bgcolor--white bshadow--1 bradius--small">
                    <div class="c100 p15 rad_progress_size_small"><span>80%</span>
                      <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                      </div>
                    </div>
                    <div class="stat-box-content color--fadeblue"><span class="stat-box-text">عملاء افراد</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="stat-box stat-box-3 margin--small-top-bottom bgcolor--white bshadow--1 bradius--small">
                    ...
                    <div class="stat-box-content color--fadeblue"><span class="stat-box-text">عملاء شركات</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="stat-box stat-box-3 margin--small-top-bottom bgcolor--white bshadow--1 bradius--small">
                    ...
                    <div class="stat-box-content color--fadeblue"><span class="stat-box-text">عملاء افراد - شركات</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-lg-3">
                  <div class="stat-box stat-box-3 margin--small-top-bottom bgcolor--white bshadow--1 bradius--small">
                    ...
                    <div class="stat-box-content color--fadeblue"><span class="stat-box-text">عملاء استشارات عبر التطبيق</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="stat-box margin--small-top-bottom bgcolor--white bshadow--1 bradius--small"><span class="stat-box-icon bgcolor--fadeorange color--white"><i class="fa fa fa-gavel"></i></span>
                    <div class="stat-box-content color--fadeorange"><span class="stat-box-text">عدد القضايا</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="stat-box margin--small-top-bottom bgcolor--white bshadow--1 bradius--small"><span class="stat-box-icon bgcolor--gray_d color--white"><i class="fa fa fa-tag"></i></span>
                    <div class="stat-box-content color--gray_d"><span class="stat-box-text">عدد الخدمات المدفوعة</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="stat-box margin--small-top-bottom bgcolor--white bshadow--1 bradius--small"><span class="stat-box-icon bgcolor--fadebrown color--white"><i class="fa fa fa-gift"></i></span>
                    <div class="stat-box-content color--fadebrown"><span class="stat-box-text">عدد الخدمات المجانية</span><span class="stat-box-number">1,410</span></div>
                  </div>
                </div>
                <div class="col-md-12">
