...
<html lang="ar">
  <head>
    ...
    <title>Avocato</title>
    <!-- =============== APP STYLES ===============-->
    <link rel="stylesheet" href="{{asset('land/css/style__rtl.css')}}">
    <!-- =============== APP SCRIPT ===============-->
...
<b>أفوكاتو </b>
المجتمع الرائد الوحيد للخدمات القانونية.
                    ...
                    <div class="text-center col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
                      <ul class="list-inline">
                        <li class="item-list col-md-6 col-sm-6 col-xs-6"><a class="store-btn" href="https://itunes.apple.com/us/app/avocato/id1381221725?ls=1&mt=8 "><img class="img-responsive" src="{{asset('img/btn-ios.png')}}"></a></li>
                        <li class="item-list col-md-6 col-sm-6 col-xs-6"><a class="store-btn" href="https://play.google.com/store/apps/details?id=com.pentavalue.secure_bridge"><img class="img-responsive" src="{{asset('img/btn-android.png')}}"></a></li>
                      </ul>
                    </div>
                    <div class="clearfix"></div><br>
                  ...
                  <section class="tabs t-tabs" id="fancyTabWidget">
                    <ul class="nav nav-tabs fancyTabs" role="tablist">
                      ...
                      <li class="tab fancyTab">
                        <div class="arrow-down">
                          <div class="arrow-down-inner"></div>
                        </div><a id="tab2" href="#tabBody2" role="tab" aria-controls="tabBody2" aria-selected="true" data-toggle="tab" tabindex="0"><span class="fa fa-black-tie"></span><span class="hidden-xs">مكتب - شركة محاماه</span></a>
                        <div class="whiteBlock"></div>
                      </li>
                    </ul>
                ...
                {{csrf_field()}}
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <select name="gender" class="master_input select2" id="client_gender" style="width:100%;">
                              ...
                              <option value="{{$gender->item_id}}"> {{$gender->value}} </option>
                              @endforeach
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="job" value="{{ old('job') }}" class="master_input" type="text" placeholder="المسمى الوظيفي  .." id="client_job"><span class="master_message color--fadegreen">
                                  @if ($errors->has('job'))
                                    {{ $errors->first('job')}}
                                    @endif </span>
                          </div>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="address" value="{{ old('address') }}" class="master_input" type="text" placeholder="عنوان العميل .." id="client_address"><span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="national_id" value="{{ old('national_id') }}" class="master_input" type="text" placeholder="الرقم القومى" id="client_id"><span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="phone" value="{{ old('phone') }}" class="master_input" type="text" placeholder="رقم الهاتف" id="client_tel"><span class="master_message color--fadegreen">
                                  @if ($errors->has('phone'))
                                    {{ $errors->first('phone')}}
                                    @endif</span>
                          </div>
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="email" value="{{ old('email') }}" class="master_input" type="email" placeholder="البريد الالكترونى" id="client_email"><span class="master_message color--fadegreen">
                                  @if ($errors->has('email'))
                                    {{ $errors->first('email')}}
                                    @endif</span>
                          </div>
                      ...
                      {{csrf_field()}}
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="office_name" value="{{ old('office_name') }}" class="master_input" type="text" placeholder="اسم المكتب .." id="office_name"><span class="master_message color--fadegreen">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                      <div class="master_field">
                        <label class="master_label">لوجو المكتب</label>
                        <div class="file-upload">
                          <div class="file-select">
                            <div class="file-select-name" id="noFile">لوجو المكتب</div>
