              ...
              <div class="container">
                <div class="row">
                  <div class="col-xs-12">
                    ...
                    <h4 class="color--main_d text-center col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
                ...
                {{csrf_field()}}
                        ...
                        <div class="col-md-3 col-sm-4 col-xs-12">
                          <div class="master_field">
                            ...
                            <input name="birthdate" value="{{ old('birthdate') }}" class="datepicker-popup master_input" type="text" placeholder="placeholder" id="client_birth"><span class="master_message color--fadegreen">
