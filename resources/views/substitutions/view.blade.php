                        ...
                        <div class="clearfix">
                          <div class="layer clearfix">
                            <div class="tck-info col-xs-12">
                              <div class="col-xs-12"><span class="tiket-data light-color col-md-4 col-xs-6 bold">نوع الإنابة: <b class="color--sec">نوع</b></span><span class="tiket-data light-color col-md-4 col-xs-6">
                                  اسم المحامي الأساسي&nbsp;<a class="light-color" href="lawyer_view.html">محمد علي</a></span><span class="tiket-data light-color col-md-4 col-xs-6"> <i class="fa fa-map-marker"> </i>محكمة شرق القاهرة
                                  &nbsp;<span class="color--sec">(دائرة)</span></span><span class="tiket-data light-color col-md-4 col-xs-6">
                                  في الدعوى رقم: 135654
                              ...
                              <hr>
                              <div class="col-xs-12"><span class="tiket-data col-md-4 col-sm-6 col-xs-12"><i class="fa fa-user"></i><b>الموكل :</b>&nbsp;<span class="color--sec">مهند</span>&nbsp;
                                  وصفته
                                  &nbsp;<span class="color--sec">مهندس كهرباء</span></span><span class="tiket-data col-md-4 col-sm-6 col-xs-12"><i class="fa fa-user"></i><b>يحضر عنه :</b>&nbsp;<span class="color--sec">هاني</span>&nbsp;
                                  بتوكيل
                                  &nbsp;<span class="color--sec">164846453</span></span><span class="tiket-data col-md-4 col-sm-6 col-xs-12"><i class="fa fa-user"></i><b>الخصم :</b>&nbsp;<span class="color--sec">محمد</span>&nbsp;
                                  وصفته
                                  &nbsp;<span class="color--sec">مهندس كهرباء</span></span></div>
                              <div class="clearfix"></div>
                              <hr><span class="tiket-data col-xs-12"><b class="col-md-12">موضوع الدعوى :</b>
                                <div class="col-md-12"> لوريم ايبسوم دولار سيت أميت ,كونسيكتيتور أدايبا يسكينج أليايت,سيت دو أيوسمود تيمبورأنكايديديونتيوت لابوري ات دولار ماجنا أليكيوا . يوت انيم أد مينيم فينايم,كيواس نوستريد أكسير سيتاشن يللأمكو لابورأس نيسي يت أليكيوب أكس أيا كوممودو كونسيكيوات . ديواس أيوتي أريري دولار إن ريبريهينديرأيت فوليوبتاتي فيلايت أيسسي كايلليوم دولار أيو فيجايت نيولا باراياتيور. أيكسسيبتيور ساينت أوككايكات كيوبايداتات نون بروايدينت ,سيونت ان كيولباكيو أوفيسيا ديسيريونتموليت انيم أيدي ايست لابوريوم.</div>
                                <div class="clearfix"></div>
                          ...
                          <div class="row">
                            <div class="col-xs-12">
                              ...
                              <div class="master_field">       
                                <input class="icon" type="radio" id="radbtn_2" checked="true">
                                <label for="radbtn_2">تمت المهمة</label>
                                <input class="icon" type="radio" id="radbtn_3">
