                      ...
                      <div class="remodal-bg">
                        <div class="remodal" data-remodal-id="filterModal_sponsors" role="dialog" aria-labelledby="modal1Title" aria-describedby="modal1Desc">
                          ...
                          <div>
                            ...
                            <div class="col-md-6">
                              <div class="master_field">
                                <label class="master_label mandatory" for="rep_name">القائم بالاجراء</label>
                                <input class="master_input" type="text" placeholder="القائم بالاجراء" id="rep_name"><span class="master_message color--fadegreen">message</span>
                              </div>
                            </div>
                          </div>
                      ...
                      <table class="table-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><span class="cellcontent"><a href= "{{route('services_show')}}" ,  class= "action-btn bgcolor--main color--white "><i class = "fa  fa-eye"></i></a><a href= "{{route('services_edit')}}" ,  class= "action-btn bgcolor--fadegreen color--white "><i class = "fa  fa-pencil"></i></a><a href="#"  class= "btn-warning-cancel action-btn bgcolor--fadebrown color--white "><i class = "fa  fa-trash-o"></i></a></span></td>
                          </tr>
                          <tr>
                            <td><span class="cellcontent"><input type="checkbox" class="checkboxes" /></span></td>
                            <td><span class="cellcontent">20122</span></td>
