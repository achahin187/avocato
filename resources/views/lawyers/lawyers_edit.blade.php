...
{{--                         <div class="master_field">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input value="{{$lawyer->birthdate}}" name="birthdate" class="datepicker master_input" type="text" placeholder="placeholder" id="lawyer_birth"><span class="master_message color--fadegreen">
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        ...
                        <div class="master_field">
                          ...
                          <input value="{{$lawyer->user_detail->work_sector}}" name="work_sector" class="master_input" type="text" placeholder="التخصص" id="lawyer_work_sector"><span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input  readonly value="{{$lawyer->user_detail->join_date}}" name="join_date" class="datepicker master_input" type="text" placeholder="placeholder" id="work_start"><span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input readonly value="{{$lawyer->user_detail->resign_date}}" name="resign_date" class="datepicker master_input" type="text" placeholder="placeholder" id="work_end"><span class="master_message color--fadegreen">
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input value="{{$lawyer->user_detail->syndicate_level}}" name="syndicate_level" class="master_input" type="text" placeholder="درجة القيد بالنقابة .." id="lawyer_degree_in"><span class="master_message color--fadegreen">
