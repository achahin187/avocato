                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input  value="{{$lawyer->user_detail->join_date}}" name="join_date" class="datepicker master_input" type="text" placeholder="placeholder" id="work_start"><span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input value="{{$lawyer->user_detail->resign_date}}" name="resign_date" class="datepicker master_input" type="text" placeholder="placeholder" id="work_end"><span class="master_message color--fadegreen">
