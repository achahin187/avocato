                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="name" value="{{ old('name') }}" class="master_input" type="text" placeholder="اسم المحامى .." id="lawyer_name">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="address" value="{{ old('address') }}" class="master_input" type="text" placeholder="عنوان المحامى .." id="lawyer_address">
                          <span class="master_message color--fadegreen"> 
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="national_id" value="{{ old('national_id') }}" class="master_input" type="number" placeholder="الرقم القومى" id="lawyer_id">
                          <span class="master_message color--fadegreen">            
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="birthdate" value="{{ old('birthdate') }}" class="datepicker_birthdate master_input" type="text" placeholder="اكتب تاريخ الميلاد هنا" id="lawyer_birth">
                          <span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="phone" value="{{ old('phone') }}" class="master_input" type="text" placeholder="رقم الهاتف" id="lawyer_tel">
                          <span class="master_message color--fadegreen">
                            @if ($errors->has('phone'))
                              {{ $errors->first('phone')}}
                            @endif
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="mobile" value="{{ old('mobile') }}" class="master_input" type="text" placeholder="رقم الهاتف الجوال" id="lawyer_mob">
                          <span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="email" value="{{ old('email') }}" class="master_input" type="email" placeholder="البريد الالكترونى" id="lawyer_email">
                          <span class="master_message color--fadegreen">
                              @if ($errors->has('email'))
                                {{ $errors->first('email')}}
                              @endif
                      ...
                      <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="master_field">
                          ...
                          <textarea value="{{ old('note') }}" class="master_input" name="note" id="lawyer_info" placeholder="نبذة"></textarea>
                          <span class="master_message color--fadegreen">
                              @if ($errors->has('note'))
                                  {{ $errors->first('note')}}
                              @endif
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="litigation_level" value="{{ old('litigation_level') }}" class="master_input" type="text" placeholder="درجة التقاضي.." id="lawyer_degrees">
                          <span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="join_date" value="{{ old('join_date') }}" class="datepicker_join_date master_input" readonly type="text" placeholder="اكتب تاريخ الالتحاق بالعمل هنا" id="work_start">
                          <span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input name="resign_date" value="{{ old('resign_date') }}" class="datepicker master_input" readonly type="text" placeholder="اكتب تاريخ انتهاء العمل بالشركة هنا" id="work_end">
                          <span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-2 col-sm-6 col-xs-6">
                        <div class="master_field">
                          ...
                          <input value="{{ old('consultation_price') }}" name="consultation_price" class="master_input" type="number" placeholder="سعر الإستشارة" id="consultation_cost">
                          <span class="master_message color--fadegreen">
                      ...
                      <div class="col-md-8 col-sm-6 col-xs-12">
                        <div class="master_field">
                          ...
                          <input value="{{ old('international_arbitrator_specialization') }}" name="international_arbitrator_specialization" class="master_input" type="text" placeholder="التخصص كمحكم في وزارة العدل " id="judge_res">
                          <span class="master_message color--fadegreen">
                    ...
                    <div class="cardwrap bgcolor--white bradius--noborder   bshadow--1 padding--small margin--small-top-bottom">
                      ...
                      <div class="col-md-2 col-sm-6 col-xs-6">
                        <a href="{{route('lawyers')}}">
                          <button class="master-btn undefined btn-block color--white bgcolor--fadebrown bradius--small bshadow--0" type="button"><i class="fa fa-times"></i><span>الغاء</span>
                          </button>
                        </a>
                      </div>
                    </form>
